...
class BatchNormNormalizerConfig(BaseConfig):
    name: tp.Literal["BatchNormNormalizer"] = "BatchNormNormalizer"
    momentum: float = 0.01
...
class IdentityNormalizerConfig(BaseConfig):
    name: tp.Literal["IdentityNormalizer"] = "IdentityNormalizer"
...
class RGBNormalizerConfig(BaseConfig):
    name: tp.Literal["RGBNormalizer"] = "RGBNormalizer"
